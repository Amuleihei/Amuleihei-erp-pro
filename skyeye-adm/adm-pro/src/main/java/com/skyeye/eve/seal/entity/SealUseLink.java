...
/**
 * @ClassName: SealUseLink
 * @Description: 印章借用申请关联的印章信息实体类
 ...
 */
@Data
@TableName(value = "seal_use_goods")
@ApiModel("印章借用申请关联的印章信息实体类")
public class SealUseLink extends SkyeyeLinkData {
