...
/**
 * @ClassName: LicenceRevertLinkService
 * @Description: 证照归还申请关联的证照信息服务接口层
 * @author: skyeye云系列--卫志强
 * @date: 2022/12/19 19:52
 * @Copyright: 2022 https://gitee.com/doc_wei01/skyeye Inc. All rights reserved.
 * 注意：本内容仅限购买后使用.禁止私自外泄以及用于其他的商业目的
 */
public interface LicenceRevertLinkService extends SkyeyeLinkDataService<LicenceRevertLink> {
