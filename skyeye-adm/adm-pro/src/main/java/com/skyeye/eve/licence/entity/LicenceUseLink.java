...
/**
 * @ClassName: LicenceUseLink
 * @Description: 证照借用申请关联的证照信息实体类
 ...
 */
@Data
@TableName(value = "licence_use_goods")
@ApiModel("证照借用申请关联的证照信息实体类")
public class LicenceUseLink extends SkyeyeLinkData {
