...
/**
 * @ClassName: AssetUseLink
 * @Description: 资产领用申请关联的资产信息实体类
 ...
 */
@Data
@TableName(value = "asset_use_goods")
@ApiModel("资产领用申请关联的资产信息实体类")
public class AssetUseLink extends SkyeyeLinkData {
