 ...
 */
@Data
@RedisCacheField(name = "school:measurement", cacheTime = RedisConstants.HALF_A_YEAR_SECONDS)
@TableName(value = "school_measurement")
@ApiModel(value = "测试管理实体类")
public class Measurement extends BaseGeneralInfo {
    ...
    @ApiModelProperty(value = "应用环节，参考#MeasurementApplicationProcess", required = "required")
    ...
    @TableField("type")
    @ApiModelProperty(value = "类型，参考#MeasurementType", required = "required")
    private String type;
    ...
    @TableField(exist = false)
    @Property(value = "学生作业提交状态，参考#MeasurementSubState")
