...
<title>Skyeye-JDeploy自动化部署平台</title>
...
<body style="font-family: 'Roboto', 'Droid Sans Fallback', '微软雅黑';min-height: 100vh;display: flex;flex-direction: column;">
	...
	<nav>
		<div class="nav-wrapper">
			<a href="${pageContext.request.contextPath}/" class="brand-logo center">Skyeye-JDeploy自动化部署平台</a>
		</div>
	</nav>
						...
						<div class="card-content">
							<span class="card-title black-text">新建项目</span>
								...
								<div class="row">
									...
									<div class="input-field col s12" style="min-height: 70px;">
									...
									<div class="input-field col s6 input-field-branch" style="display: none;">
										<input type="text" id="input-gitFolderName" name="gitFolderName">
										<label for="input-branch">如果一个git地址上有多个项目，则为目录节点，例如：/skyeye-shop</label>
									</div>
									<div class="input-field col s12">
										<input type="text" name="startParams">
										<label for="input-url">启动参数</label>
									</div>
								</div>
	...
	<footer class="page-footer" style="padding-top: 0; margin-top: 40px;">
      <div class="footer-copyright">
        <div class="container">
        Copyright © 2022 <a class="grey-text text-lighten-4" href="https://gitee.com/doc_wei01/skyeye" target="_blank">https://gitee.com/doc_wei01/skyeye</a>. All rights reserved.
			<a class="grey-text text-lighten-4 right" href="https://gitee.com/doc_wei01/skyeye" target="_blank">Gitee</a>
        </div>
      </div>
    </footer>
