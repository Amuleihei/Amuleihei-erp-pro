...
public class WxNativePayClient extends AbstractWxPayClient {
    ...
    protected PayOrderRespDTO doUnifiedOrderV2(PayOrderUnifiedReqDTO reqDTO) throws WxPayException {
        ...
        // 转换结果
        return PayOrderRespDTO.waitingOf(PayOrderDisplayMode.QR_CODE.getKey(), response.getCodeUrl(),
    ...
    protected PayOrderRespDTO doUnifiedOrderV3(PayOrderUnifiedReqDTO reqDTO) throws WxPayException {
        ...
        // 转换结果
        return PayOrderRespDTO.waitingOf(PayOrderDisplayMode.QR_CODE.getKey(), response,
            reqDTO.getOutTradeNo(), response);
    }
