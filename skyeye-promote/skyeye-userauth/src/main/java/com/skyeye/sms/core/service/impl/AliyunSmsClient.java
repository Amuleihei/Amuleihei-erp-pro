...
/**
 * @ClassName: AliyunSmsClient
 * @Description: 阿里短信客户端的实现类
...
public class AliyunSmsClient extends AbstractSmsClient {
    ...
    public AliyunSmsClient(SmsChannel properties) {
        super(properties);
    ...
    public SmsSendResp sendSms(String mobile, String apiTemplateId,
        ...
        Assert.notBlank(properties.getName(), "短信签名不能为空");
        // 1. 执行请求
