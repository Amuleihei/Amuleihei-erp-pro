...
/**
 * @ClassName: MilestoneAuthEnum
 * @Description: 里程碑权限控制枚举类
...
@NoArgsConstructor
@AllArgsConstructor
public enum MilestoneAuthEnum implements SkyeyeEnumClass {

    LIST("list", "所有里程碑列表", true, false),
    MY_CREATE("myCreate", "我创建的里程碑列表", true, false),
