...
public class ActiveMultiInstanceTaskRollbackOperateStrategy extends AbstractRollbackOperateStrategy {
    ...
    private void processSequentialInstance() {
        ...
        if (executionEntity.getId().equals(hisTask.getExecutionId())) {
            ...
            // 配置任务执行人
            executionEntity.setVariable(ActivitiConstants.ASSIGNEE_USER, assignee);
            // 计数器前置一位
            ...
            List<String> assigneeList = (List<String>) runtimeService.getVariableLocal(currentTask.getProcessInstanceId(), ActivitiConstants.ASSIGNEE_USER_LIST);
            ...
            runtimeService.setVariableLocal(currentTask.getProcessInstanceId(), ActivitiConstants.ASSIGNEE_USER_LIST, assigneeList);
            ...
            newExecution.setVariableLocal(ActivitiConstants.ASSIGNEE_USER, assignee);
    ...
    private void processMultiInstance() {
        ...
        if (executionEntity.getId().equals(hisTask.getExecutionId())) {
            ...
            newExecution.setVariable(ActivitiConstants.ASSIGNEE_USER, assignee);
    ...
    private ExecutionEntity processCommon(HistoricTaskInstance hisTask) {
        ...
        ExecutionEntity parentExecutionEntity =
            CommandContextUtil.getExecutionEntityManager(commandContext).findById(executionEntity.getParentId());
