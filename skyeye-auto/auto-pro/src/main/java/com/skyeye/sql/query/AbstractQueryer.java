...
import com.skyeye.sql.entity.*;
import com.skyeye.sql.util.JdbcUtils;
...
public abstract class AbstractQueryer {
    ...
    protected AutoDataSource dataSource;

    protected AbstractQueryer(AutoDataSource dataSource) {
