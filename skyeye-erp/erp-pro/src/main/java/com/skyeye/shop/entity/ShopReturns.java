 ...
 */
@Data
@RedisCacheField(name = "erp:order:shopReturns", cacheTime = RedisConstants.TOW_MONTH_SECONDS)
@TableName(value = "erp_depothead", autoResultMap = true)
@ApiModel("门店退货单实体类")
public class ShopReturns extends ErpOrderHead {
