 ...
 */
@Data
@RedisCacheField(name = "erp:order:purchaseReturn", cacheTime = RedisConstants.TOW_MONTH_SECONDS)
@TableName(value = "erp_depothead", autoResultMap = true)
@ApiModel("采购退货单实体类")
public class PurchaseReturn extends ErpOrderHead {
